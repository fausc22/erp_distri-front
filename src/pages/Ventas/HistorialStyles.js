...
export const TableContainer = styled.div`
    ...
    th:nth-child(1), td:nth-child(1) { width: 5px; }  /* Código */
    th:nth-child(2), td:nth-child(2) { width: 5px; } /* Nombre del producto */
    th:nth-child(3), td:nth-child(3) { width: 3px; } /* Unidad de medida */
    th:nth-child(4), td:nth-child(4) { width: 4px } /* Cantidad */
    th:nth-child(5), td:nth-child(5) { width: 5px; } /* Precio Unitario */
    th:nth-child(6), td:nth-child(6) { width: 5px; } /* IVA */
    th:nth-child(7), td:nth-child(7) { width: 5px; } /* Subtotal */
`;
